    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(db_index=True, default=django.utils.timezone.now, verbose_name='Date de vente')),
        ...
        migrations.AddField(
            model_name='vente',
            name='produits',
            field=models.ManyToManyField(related_name='ventes', through='ventes.VenteDetail', to='produits.produit'),
        ),
    ]
